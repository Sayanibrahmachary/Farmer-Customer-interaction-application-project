...
function ChangePassword({email})
{
	...
	const handleChangePassword=async(e)=>
	{
		...
		try{
			...
			const response=await fetch(`http://localhost:8000/api/v1/customers/changePasswordCustomer`,{
				method: "POST",
				headers: {
            ...
            <div className="changePasswordSection">
                ...
                <div className="rightSideChangePassword">
                    ...
                    <form className="formChangePassword">
						...
						<button className="btn" type="submit" onClick={handleChangePassword}>Login</button>
					</form>
                    </div>
                </div>
            </div>
