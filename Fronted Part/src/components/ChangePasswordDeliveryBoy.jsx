...
function changePasswordDeliveryBoy({email})
{
    const [oldPassword,setOldPassword]=useState("");
        ...
        const handleChangePassword=async(e)=>
        {
            ...
            try{
                ...
                const response=await fetch(`http://localhost:8000/api/v1/deliveryBoy/changePasswordDeliveryBoy`,{
                    method: "POST",
                    headers: {
...
export default changePasswordDeliveryBoy;