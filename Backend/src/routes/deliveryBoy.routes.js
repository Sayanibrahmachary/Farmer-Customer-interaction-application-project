...
import { registerDeliveryBoy,logInDeliveryBoy,logOutDeliveryBoy,changePasswordDeliveryBoy ,refreshAccessToken, useingPinCheckUser,bookDeliveryBoy} from "../controllers/deliverBoy.controller.js";
...
router.route("/bookDeliveryBoy/:customerId").post(bookDeliveryBoy);
